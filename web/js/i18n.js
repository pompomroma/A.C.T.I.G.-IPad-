...
const STR = {
  en: {
    ...
    'ack.largeModelTrying':'Attempting the larger model, sir — I will fall back automatically if this device cannot hold it.',
  ...
  ko: {
    ...
    'ack.largeModelTrying':'더 큰 모델을 시도합니다 주인님 — 이 기기가 감당하지 못하면 자동으로 작은 모델로 돌아갑니다.',
